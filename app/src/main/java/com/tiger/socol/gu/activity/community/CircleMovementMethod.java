...
import com.tiger.socol.gu.MainApplication;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = MainApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MainApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
