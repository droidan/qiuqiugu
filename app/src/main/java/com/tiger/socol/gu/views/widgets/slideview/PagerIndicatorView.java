...
import com.tiger.socol.gu.views.widgets.slideview.tricks.InfinitePagerAdapter;
import com.tiger.socol.gu.views.widgets.slideview.tricks.ViewPagerEx;
 ...
 * Pager Indicator.
 */
public class PagerIndicatorView extends LinearLayout implements
    ...
    public PagerIndicatorView(Context context, AttributeSet attrs) {
        ...
        final TypedArray attributes = context.obtainStyledAttributes(attrs,
                R.styleable.PagerIndicatorView, 0, 0);

        int visibility = attributes.getInt(
                R.styleable.PagerIndicatorView_visibility,
        ...
        int shape = attributes.getInt(R.styleable.PagerIndicatorView_shape,
                Shape.Oval.ordinal());
        ...
        mUserSetSelectedIndicatorResId = attributes.getResourceId(
                R.styleable.PagerIndicatorView_selected_drawable, 0);
        mUserSetUnSelectedIndicatorResId = attributes.getResourceId(
                R.styleable.PagerIndicatorView_unselected_drawable, 0);

        mDefaultSelectedColor = attributes.getColor(
                R.styleable.PagerIndicatorView_selected_color,
                Color.rgb(255, 255, 255));

        mDefaultUnSelectedColor = attributes.getColor(
                R.styleable.PagerIndicatorView_unselected_color,
                Color.argb(33, 255, 255, 255));

        mDefaultSelectedWidth = attributes.getDimension(
                R.styleable.PagerIndicatorView_selected_width, (int) pxFromDp(6));
        mDefaultSelectedHeight = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_selected_height, (int) pxFromDp(6));

        mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_unselected_width, (int) pxFromDp(6));
        mDefaultUnSelectedHeight = attributes
                .getDimensionPixelSize(
                        R.styleable.PagerIndicatorView_unselected_height,
                        (int) pxFromDp(6));
        ...
        mPadding_left = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_padding_left, (int) pxFromDp(3));
        mPadding_right = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_padding_right, (int) pxFromDp(3));
        mPadding_top = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_padding_top, (int) pxFromDp(0));
        mPadding_bottom = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_padding_bottom, (int) pxFromDp(0));
        ...
        mSelectedPadding_Left = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_selected_padding_left,
                (int) pxFromDp(3));
        mSelectedPadding_Right = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_selected_padding_right,
                (int) pxFromDp(3));
        mSelectedPadding_Top = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_selected_padding_top,
                (int) pxFromDp(0));
        mSelectedPadding_Bottom = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_selected_padding_bottom,
                (int) pxFromDp(0));

        mUnSelectedPadding_Left = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_unselected_padding_left,
                (int) pxFromDp(3));
        mUnSelectedPadding_Right = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_unselected_padding_right,
                (int) pxFromDp(3));
        mUnSelectedPadding_Top = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_unselected_padding_top,
                (int) pxFromDp(0));
        mUnSelectedPadding_Bottom = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicatorView_unselected_padding_bottom,
                (int) pxFromDp(0));
        ...
        setDefaultPadding(mPadding_left, mPadding_top, mPadding_right,
                mPadding_bottom, Unit.Px);
        ...
        setDefaultUnSelectedPadding(mUnSelectedPadding_Left,
                mUnSelectedPadding_Top, mUnSelectedPadding_Right,
                mUnSelectedPadding_Bottom, Unit.Px);
        attributes.recycle();
    }
    ...
    public void setDefaultPadding(float left, float top, float right,
                                  float bottom, Unit unit) {
        if (mUserSetSelectedIndicatorResId == 0) {
            if (unit == Unit.DP) {
                mSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left),
                        (int) pxFromDp(top), (int) pxFromDp(right),
                        (int) pxFromDp(bottom));
                mUnSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left),
                        (int) pxFromDp(top), (int) pxFromDp(right),
                        (int) pxFromDp(bottom));
            } else {
                mSelectedLayerDrawable.setLayerInset(0, (int) left, (int) top,
                        (int) right, (int) bottom);
                mUnSelectedLayerDrawable.setLayerInset(0, (int) left,
                        (int) top, (int) right, (int) bottom);
            }
        }
    }

    public void setDefaultSelectedPadding(float left, float top, float right,
                                          float bottom, Unit unit) {
        if (mUserSetSelectedIndicatorResId == 0) {
            if (unit == Unit.DP) {
                mSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left),
    ...
    public void setDefaultUnSelectedPadding(float left, float top, float right,
                                            float bottom, Unit unit) {
        if (mUserSetSelectedIndicatorResId == 0) {
            if (unit == Unit.DP) {
                mUnSelectedLayerDrawable.setLayerInset(0, (int) pxFromDp(left),
    ...
    public void setIndicatorStyleResource(int selected, int unselected) {
        ...
        if (unselected == 0) {
            ...
            mUnselectedDrawable =
                    ContextCompat.getDrawable(mContext, mUserSetUnSelectedIndicatorResId);
        }
    ...
    public void destroySelf() {
        ...
        InfinitePagerAdapter wrapper = (InfinitePagerAdapter) mPager
                .getAdapter();
    ...
    public void setViewPager(ViewPagerEx pager) {
        ...
        ((InfinitePagerAdapter) mPager.getAdapter()).getRealAdapter()
